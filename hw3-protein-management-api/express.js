...
// // Helper function to read protein data from the file
// function readProteinData(callback) {
//     fs.readFile('data/proteins.json', 'utf8', (err, data) => {
//         if (err) {
...
app.post('/api/proteins/sequence', (req, res) => {
...
app.put('/api/proteins/:proteinId', (req, res) => {
    ...
    readProteinData((err, proteins) => {
        ...
        fs.writeFile('data/proteins.json', JSON.stringify(proteins, null, 2), (writeErr) => {
            ...
            console.log("Updated Protein Data:", updatedProtein);
...
app.delete('/api/proteins/:proteinId', (req, res) => {
    const { proteinId } = req.params; 
